...
| make_class                  | Seems to determine the pilot ids when they are queried. These are defined in shipclasses.ini, but the properties seem to be hardcoded. For example `class_patroller` will id a formation member as something like 'patrol yellow 4' when hailed. Testing required to confirm this.                                                                                                                                                                                                                                                                                           |
