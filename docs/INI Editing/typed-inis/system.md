...
| repop_time            | If the current ship count within the zone is less than `density`, the game will try to repopulate the zone for a chance calculated by `(density - ships) / repop_time` about every 5 seconds (possibly releated to `SpacePop` in [freelancer.ini](../hardcoded-inis/exe/freelancer.ini.md)).                                                                                                                                                                                                                                                                            |
