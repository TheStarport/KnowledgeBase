...
| relief_time           | Determines the latest moment an encounter will disappear after being spawned, either by docking or leaving the player's range.                                                                                                                                                                                                                  |
...
| density_restriction   | Limits the number of encounter instances of a given type to the number provided. This parameter respects the `make_class` field in the encounter block.                                                                                                                                                                                                                                                                                                                                                |
