...
| vignette_type         |                                                                                                                                                                                                                                                                                                                                                 |
| toughness             |                                                                                                                                                                                                                                                                                                                                                 |
| density               | This determines the number of `ship_by_class` entries in encounter blocks generated by this zone that can be present at the same time.                                                                                                                                                                    |
...
| density_restriction   | Limits the number of `ship_by_class` blocks of a given time to the number provided. This parameter respects the `make_class` field in the encounter block.                                                                                                                                                                                                                                                                                                                                                |
